...
const MadhyaPradesh = () => {
  ...
  const districtDescriptions = {
            ...
            'Ujjain': 'Ujjain is one of the seven sacred cities of Hinduism and is famous for the Mahakaleshwar Temple. The city is known for its ancient astronomical observatory and hosts the famous Kumbh Mela.',
            ...
            'Raisen': 'Raisen is known for its historical forts and palaces. The district is home to the famous Sanchi Stupa and has a rich archaeological history. It\'s also known for its agricultural produce.',
